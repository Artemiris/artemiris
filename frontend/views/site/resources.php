...
<div class="row">
    <div class="col-xs-12 col-sm-8">
        <h3><?= Yii::t('resources', 'GIS') ?> «<?= Yii::t('resources', 'Rock art of Siberia') ?>»</h3>
        <p>
            <?= Yii::t('resources', 'Geographic information system of Altai petroglyphs. Sites of Transbaikalia and Khakassia') ?>
        </p>
        <p>
            <?= Yii::t('resources', 'Access to the spatial data is limited, requests for access are accepted by e-mail') ?>:
            <a href="mailto:mirrorlab.artemir@gmail.com">mirrorlab.artemir@gmail.com</a>
        </p>
        <p>
            <a href="http://rockart.artemiris.org/" target="_blank"
               class="btn btn-primary"><?= Yii::t('app', 'Go to') ?></a>
        </p>
    </div>
    <div class="col-xs-12 col-sm-4">
        <img src="/img/resources/rockart.jpg" alt="<?= Yii::t('resources', 'GIS') ?> «<?= Yii::t('resources', 'Rock art of Siberia') ?>»" class="img-responsive">
    </div>
</div>
<br>
...
<div class="row">
    <div class="col-xs-12 col-sm-8">
        <h3><?= Yii::t('resources', 'IS') ?> «<?= Yii::t('resources', 'Mobile art of Siberia') ?>»</h3>
        <p>
            <?= Yii::t('resources', 'A collection of personalized objects, which was obtained in materials from more than 20 archaeological sites in Siberia') ?>
        </p>
        <p>
            <a href="http://mobileart.artemiris.org/" target="_blank"
               class="btn btn-primary"><?= Yii::t('app', 'Go to') ?></a>
        </p>
    </div>
    <div class="col-xs-12 col-sm-4">
        <img src="/img/resources/mobileart.jpg" alt="<?= Yii::t('resources', 'IS') ?> «<?= Yii::t('resources', 'Mobile art of Siberia') ?>»" class="img-responsive">
    </div>
</div>
<br>
...
<div class="row">
    <div class="col-xs-12 col-sm-8">
        <h3><?= Yii::t('resources', 'IS') ?> «<?= Yii::t('resources', "Art of Mal'ta") ?>»</h3>
        <p>
            <?= Yii::t('resources', "The collection of mobile art of the location of Mal'ta - a multi-layered geoarchaeological object of the Upper Paleolithic") ?>
        </p>
        <p>
            <a href="http://malta.artemiris.org/" target="_blank"
               class="btn btn-primary"><?= Yii::t('app', 'Go to') ?></a>
        </p>
    </div>
    <div class="col-xs-12 col-sm-4">
        <img src="/img/resources/malta.jpg" alt="<?= Yii::t('resources', 'IS') ?> «<?= Yii::t('resources', "Art of Mal'ta") ?>»" class="img-responsive">
    </div>
</div>
<br>
